...
class AuthMiddleware:
    def __init__(self, auth_client: AuthClient):
        ...
        self.permission_map = {
            ...
            (re.compile(r"^/reed$"), "GET"): None,
            (re.compile(r"^/reed$"), "POST"): "MODIFY_DEVICES",
            (re.compile(r"^/reed$"), "PUT"): "MODIFY_DEVICES",
            (re.compile(r"^/reed$"), "DELETE"): "MODIFY_DEVICES",
            (re.compile(r"^/pir$"), "GET"): None,
